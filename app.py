...
# 3. واجهة المستخدم (التنسيق المحدث للنصوص البيضاء العريضة)
st.markdown("""
    <style>
    ...
    /* القائمة الجانبية خلفية داكنة جداً للتباين */
    ...
    /* تعديل نصوص القائمة لتكون بيضاء عريضة */
    ...
    div[data-testid="stSidebarUserContent"] .stRadio label {
        ...
        font-weight: 700 !important; /* نص عريض */
        font-size: 18px !important; /* حجم أوضح */
        border: 1px solid #333 !important;
        transition: 0.3s;
    }

    /* الزر النشط يتميز بلون أخضر هادئ مع بقاء النص أبيض عريض */
